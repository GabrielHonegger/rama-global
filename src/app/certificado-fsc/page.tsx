      ...
      <div className="m-auto mt-3 lg:mt-6 w-full lg:w-10/12 px-6 lg:py-4">
            ...
            <div className="w-full flex flex-col-reverse lg:flex-row">
              <div  className="lg:w-1/2 w-full lg:pr-6 flex-wrap mt-3">
                <p>
                    O Certificado FSC (Forest Stewardship Council) é uma certificado 
            ...
            <div className='w-full mb-8 md:mb-4 mt-5'>
              <p>
                ...
                <br /><br />
                <span className='font-bold text-lg'>Importância do Certificado FSC</span>
                <br />
                A importância do certificado FSC reside na sua capacidade de assegurar aos 
                ...
                <br />
                O Certificado FSC é especialmente relevante para empresas que atuam nos setores de madeira, 
                ...
                <br /><br />
                <span className='font-bold text-lg'>Vantagens do Certificado FSC</span>
                <br />
                Ter o certificado FSC traz diversas vantagens para as empresas, como:
              </p>
              <ul className='px-7 mt-2 mb-3 list-disc'>
                ...
                <p className='my-0'>
                  ...
                  <br />
                  Em suma, o certificado FSC representa uma importante ferramenta na 
                  ...
                  que buscam se destacar no mercado atual, o certificado FSC não é apenas um 

...
export default function Home() {
  return (
    <main className="m-auto">
      ...
      <div id="whatsapp" className="fixed right-10 bottom-10 bg-green-whatapp p-4 rounded-full">
        <a aria-label="Chat on WhatsApp" className="cursor-pointer" href="https://wa.me/554198730077?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20a%20consultoria" target="_blank">
